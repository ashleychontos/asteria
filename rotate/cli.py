...
import rotate
from rotate import utils
from rotate import DATADIR
...
#
    ...
    parser = argparse.ArgumentParser(
                                     description="rotate: a quick package for estimating stellar rotation periods given their teff and logg", 
                                     prog='rotate',
    )
